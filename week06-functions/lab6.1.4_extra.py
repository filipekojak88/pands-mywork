# This program stores the letter of the menu 
# and the function associated with that letter
# the function is accessed by that letter
# a different way of dealing with the users choice
